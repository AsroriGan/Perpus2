                ...
                <nav id="mainNav"
                    ...
                    <div class="container">
                        ...
                        <div class="navbar-brandr">
                            ...
                            <a class="navbar-brand" style="margin-top: 14px;" href="/"><img
                                    src="../masuk/assets/aa/44.png" style="width: 160px" class="logo"
                                    alt="Logo"></a>
                        </div>
            ...
            <div class="row">
                <div class="f-items">
                    <div class="col-md-4 col-sm-6 equal-height item">
                        <div class="f-item">
                            <img src="../masuk/assets/aa/44.png" alt="Logo">
                            <p>
                                "Perpustakaan akan membantumu melewati masa-masa tanpa uang lebih baik daripada uang
                                akan membantumu melewati masa-masa tanpa perpustakaan."
                            </p>
                    ...
                    <div class="col-md-2 col-sm-6 equal-height item">
                        <div class="f-item link">
                            ...
                            <ul>
                                <li>
                                    <p>Perpustakaan SMKN 1 Sukorejo melayani pemustaka setiap hari mulai pukul 07.30 –
                                        13.00 WIB. Layanan yang pemustaka dapatkan di perpustakaan antara lain:</p>
